...
from alabar.data import get_topics_by_owner, get_topics_by_user, get_user_by_id
...
def index():
    ...
    return render_template('index.html', table_topics=table_topics, user_session=session['CURRENT_USER'])

@alabar_bp.route('/alabar/rating')
def rating():
